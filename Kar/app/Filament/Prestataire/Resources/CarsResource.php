...
use App\Filament\Prestataire\Resources\CarsResource\Pages;
use App\Filament\Prestataire\Resources\CarsResource\RelationManagers;
...
class CarsResource extends Resource
{
    ...
    public static ?string $navigationLabel = 'Mes vehicules';
    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ->query(function () {
                ...
                return Cars::where('user_id', $user_id);
            })
            ->columns([
                TextColumn::make('id'),
